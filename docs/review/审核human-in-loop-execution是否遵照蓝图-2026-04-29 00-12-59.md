...
- `docs/hilp/构建中文裁剪版Superpowers技能/05-执行交接_no-approval_execution-handoff@v1.md`
- `docs/hilp/构建中文裁剪版Superpowers技能/03-实施蓝图_approved_implementation-blueprint@v1.md`
