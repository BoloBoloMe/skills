...
asset_path: D:/Workspace/skills/docs/hilp/改进HILP规划资产归档/03-实施蓝图_needs-approval_implementation-blueprint@v1.md
---
...
## 已保存资产
- 文件路径：`D:/Workspace/skills/docs/hilp/改进HILP规划资产归档/03-实施蓝图_needs-approval_implementation-blueprint@v1.md`
