...
asset_path: D:/Workspace/skills/docs/hilp/构建中文裁剪版Superpowers技能/05-执行交接_no-approval_execution-handoff@v1.md
---
...
## 已保存资产
- 文件路径：`D:/Workspace/skills/docs/hilp/构建中文裁剪版Superpowers技能/05-执行交接_no-approval_execution-handoff@v1.md`
