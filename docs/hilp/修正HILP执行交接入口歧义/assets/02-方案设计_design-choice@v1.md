...
asset_path: D:/Workspace/skills/docs/hilp/修正HILP执行交接入口歧义/assets/02-方案设计_design-choice@v1.md
...
- 压力测试资产：[90-协议压力测试_pressure-test@v1.md](../../HILP双Skill串联模拟测试/assets/90-协议压力测试_pressure-test@v1.md)
