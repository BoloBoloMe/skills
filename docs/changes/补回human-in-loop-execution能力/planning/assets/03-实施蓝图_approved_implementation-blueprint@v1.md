...
- 文件路径：`docs/changes/补回human-in-loop-execution能力/planning/assets/03-实施蓝图_approved_implementation-blueprint@v1.md`
...
- 覆盖矩阵引用：`stage-4-5/coverage-matrix@v1 [state=approved｜中文状态=已批准]`
