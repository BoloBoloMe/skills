...
2026-09-14 适用性补充: D054 收窄了新建容器的数量约束. 下文历史决策引用的同母体多容器场景不再授权新 birth 增加第二个活跃容器; 已有容器不迁移, 原有清理/隔离保障不撤销. 引用方待同步清单见 D054.
...
- 状态: 当前有效 (允许新 birth 增加同母体第二活跃容器的条款已由 D054 替代, 身份与命名保留)
- 约束性: 必须遵守
...
- 状态: 已替代 (由 [M04 D001](../swt-cross-host-access/milestone-04/DECISIONS.md#d001-容器对外网页端口固定为-8800-直达局域网) 定稿, M05 实施; 2026-09-14 用户拍板 web 端口 0.0.0.0 直达局域网, 双地址可达覆盖回环需求)
- 约束性: 必须遵守
