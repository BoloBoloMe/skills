...
asset_path: D:/Workspace/skills/docs/changes/HILP双Skill串联模拟测试/planning/assets/90-协议压力测试_pressure-test@v1.md
...
- 既有资产干跑输入：
  - 设计：`stage-3/design-choice@v2 [state=approved｜中文状态=已批准]`；文件链接：[02-方案设计_approved_design-choice@v2.md](../../../补回human-in-loop-execution能力/planning/assets/02-方案设计_approved_design-choice@v2.md)
  - 蓝图：`stage-4-5/implementation-blueprint@v2 [state=approved｜中文状态=已批准]`；文件链接：[03-实施蓝图_approved_implementation-blueprint@v2.md](../../../补回human-in-loop-execution能力/planning/assets/03-实施蓝图_approved_implementation-blueprint@v2.md)
  - 交接：`stage-6/execution-handoff@v2 [state=archived｜中文状态=已归档]`；文件链接：[05-执行交接_no-approval_execution-handoff@v2.md](../../../补回human-in-loop-execution能力/planning/assets/05-执行交接_no-approval_execution-handoff@v2.md)
- 实际阶段：
