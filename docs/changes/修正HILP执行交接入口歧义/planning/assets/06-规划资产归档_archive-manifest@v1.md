...
asset_path: D:/Workspace/skills/docs/changes/修正HILP执行交接入口歧义/planning/assets/06-规划资产归档_archive-manifest@v1.md
...
- 压力测试资产：`stage-test/skill-pressure-test@v1 [state=archived｜中文状态=已归档]`；文件链接：[90-协议压力测试_pressure-test@v1.md](../../../HILP双Skill串联模拟测试/planning/assets/90-协议压力测试_pressure-test@v1.md)
