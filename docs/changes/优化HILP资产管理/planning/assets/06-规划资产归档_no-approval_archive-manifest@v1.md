...
asset_path: D:/Workspace/skills/docs/changes/优化HILP资产管理/planning/assets/06-规划资产归档_no-approval_archive-manifest@v1.md
---
...
- 文件路径：`D:/Workspace/skills/docs/changes/优化HILP资产管理/planning/assets/06-规划资产归档_no-approval_archive-manifest@v1.md`
...
- 推荐入口：`D:/Workspace/skills/docs/changes/优化HILP资产管理/planning/assets/05-执行交接_no-approval_execution-handoff@v1.md`
- 推荐阅读顺序：
