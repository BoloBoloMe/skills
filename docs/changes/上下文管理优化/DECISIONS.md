...
> 命名备注 (2026-08-23 审查修正): 本账本决策时所指 `workflow/propose/SKILL.md` 已删除; 正文路径按委派语境更正为 `../../../workflow/navigate` (委派探索), 盘问收口纪律现行于 `workflow/deliberate/SKILL.md`, 两者承接边界见 skills-review-improvements/DECISIONS.md 之 F003; `adaptive-presentation` 已改名 `present` (提交 f22847e).
...
- **状态**: 当前有效
- **约束性**: 必须遵守
- **决策**: 委派逻辑写入 `../../../workflow/navigate`. `present` 保持纯展示层不感知委派. `grill-me` 不做任何委派.
