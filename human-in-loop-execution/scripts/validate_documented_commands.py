#!/usr/bin/env python3
"""Validate documented script commands in Markdown for v2.24.1."""
...
ALLOWED_OPTIONS = {
    ...
    "validate_execution_manifest.py": {"--check-paths", "--allow-draft-paths", "--planning-manifest"},
    "validate_plan_or_runbook.py": {"--handoff", "--execution-manifest", "--workspace", "--allow-tiny-unconfirmed"},
...
REQUIRED_OPTIONS = {
    ...
    "validate_execution_manifest.py": {"--check-paths", "--planning-manifest"},
    "validate_plan_or_runbook.py": {"--handoff", "--execution-manifest", "--workspace"},
