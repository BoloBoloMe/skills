# Valid HILE tiny inline completed manifest
...
manifest:
  ...
  current_assets:
    ...
    current_plan: null
    tiny_inline_record: hile/tiny-inline-record@v1
    ledger: null
    unit_summaries: null
  ...
  asset_registry:
    ...
    - asset_ref: hile/tiny-inline-record@v1
      path: agent/03-tiny-inline-record.yaml.md
      human_view: human/03-tiny-inline-record.md
      agent_view: agent/03-tiny-inline-record.yaml.md
      lifecycle_state: completed
      record_role: inline-execution-record
      version: 1
      owner_skill: human-in-loop-execution
      owner_protocol: HILE
      created_at: '2026-05-03T00:00:00Z'
