# Invalid HILP manifest: pointer artifact mismatch
...
manifest:
  ...
  asset_registry:
    - asset_ref: phase-01/requirements-facts@v1
      ...
      human_view: human/03-requirements-summary.md
    ...
    - asset_ref: phase-03/implementation-blueprint@v1
      ...
      human_view: human/04-blueprint-summary.md
    ...
    - asset_ref: phase-05/execution-handoff@v1
      ...
      human_view: human/04-handoff-summary.md
  ...
  current_pointers:
    ...
    latest_approved_design: phase-03/implementation-blueprint@v1
