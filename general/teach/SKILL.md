...
有些主题更偏知识, 例如理论物理. 有些主题更偏技能, 例如瑜伽或发音.
...
lesson 从 `./assets/` 中的可复用组件构建: 样式表, quiz widget, simulator, diagram helper 等. 复用是默认, 不是例外; 不要把将来会复制的代码内联到单个 lesson.
...
没有使命, 知识获取会脱离现实目标, lesson 会变得抽象, 你也无法判断下一步该教什么.
