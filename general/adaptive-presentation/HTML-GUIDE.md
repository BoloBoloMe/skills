...
交互只在缩放, 筛选, 切换状态或比较视图能明显改善理解时才加入. *克制的动效* 和 *附赠的彩蛋* 能给我带来情绪价值, 试图在 HTML 中给我制造小惊喜.
...
进入 HTML 分支时自动使用适配脚本调用 `access-web` skill 打开页面. 在 chat 中提供本地绝对路径链接, 一句话说明展示内容, 指出需要我观察/回答的具体问题.
