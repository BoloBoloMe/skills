...
页面整体遵循 Anthropic 式视觉美术风格: 融合人文主义, 编辑插画与现代科技美学, 强调温暖, 克制, 思考感与人与智能的连接. 落实为具体约束:

- 继承 Saul Steinberg 式概念插画精神: 简洁手绘线条, 极简构图, 用隐喻性视觉符号表达复杂思想.
- 低饱和自然色调, 纸张纹理, 文学出版物般的排版气质, 营造安静, 智慧, 有哲学意味的氛围.
- 避免赛博朋克, 霓虹渐变, 未来机械感等廉价 AI 视觉套路; 科技感要转化为温柔、有人类温度的体验.
- 视觉气质参照: 一本现代思想书籍, 一份高质量杂志插图, 一间充满阳光的创意工作室.

以上为风格偏好基线, 不覆盖信息架构, 图表复用, 可访问性等硬性约束; 冲突时优先保证信息清晰与可读.
