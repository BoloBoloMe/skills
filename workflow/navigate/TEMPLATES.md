...
<领域; 每个会话应查阅的 skill; 本次任务的固定偏好; 方向侦查结论摘要 (被选方向结论 + 未选方向排除理由)>
...
- 会话中调用 `to-execution` skill 时, 产物根目录指定为 AFK 编码任务所属 Milestone 的子目录 `docs/changes/<feature-slug>/<milestone-NN>/`
